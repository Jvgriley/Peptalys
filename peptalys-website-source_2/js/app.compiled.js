                    ...
                    React.createElement("ul", { className: "flex flex-col gap-4" }, cart.lines.map((line) => (React.createElement("li", { key: line.productId + line.variantSku, className: "flex gap-3" },
                        ...
                        React.createElement("div", { className: "flex flex-1 flex-col" },
                            ...
                            React.createElement("div", { className: "mt-2 flex items-center justify-between" },
                                React.createElement(QuantityStepper, { size: "sm", value: line.qty, onChange: (q) => Cart.setQty(line.productId, line.variantSku, q) }),
        ...
        React.createElement("section", { className: "relative overflow-hidden bg-labgrid" },
            ...
            React.createElement(Container, { className: "relative grid grid-cols-1 items-center gap-12 py-16 sm:py-20 lg:grid-cols-2 lg:py-28" },
                React.createElement("div", { className: "animate-fade-up" },
                    ...
                    React.createElement("p", { className: "mt-6 max-w-lg text-[16px] leading-relaxed text-dim" }, "Peptalys is a UK wholesale supplier of high-purity research peptides \u2014 synthesised, batch-tested and dispatched next day to laboratories and research institutions nationwide."),
                ...
                React.createElement("div", { className: "relative animate-fade-up", style: { animationDelay: "120ms" } },
                    ...
                    React.createElement("div", { className: "relative rounded-[2rem] panel p-8 sm:p-10" },
                        ...
                        React.createElement("div", { className: "mt-4" },
                            React.createElement(VialGroupGraphic, { accent: "#2F8FFF", height: 260 })),
                        React.createElement("div", { className: "mt-4 flex items-end justify-between" },
                            React.createElement("div", null,
                                React.createElement("h3", { className: "font-display text-xl font-bold text-ink" }, "Retatrutide"),
                                React.createElement("p", { className: "text-[12px] text-dim" }, "Triple-agonist \u00B7 GLP-1 / GIP / Glucagon")),
                            React.createElement(Price, { value: 11.95, size: "md" }))))),
        ...
        React.createElement("section", { className: "py-20 sm:py-28" },
            React.createElement(Container, { className: "grid grid-cols-1 items-center gap-14 lg:grid-cols-2" },
                React.createElement("div", { className: "order-2 lg:order-1" },
                    ...
                    React.createElement("p", { className: "mt-4 text-[15px] leading-relaxed text-dim" }, "Every batch is synthesised in the UK, verified by HPLC to a minimum 98% purity, and shipped in temperature-appropriate packaging on a next-day service \u2014 so what leaves our facility is exactly what your protocol expects."),
...
function useShopFilters(route) {
    const [state, setState] = React.useState({
        ...
        maxPrice: route.query.maxPrice ? Number(route.query.maxPrice) : 40,
    });
...
function ShopPage({ initialCategory }) {
    ...
    function clearAll() {
        setFilters({ q: "", categories: [], sort: "featured", inStockOnly: false, maxPrice: 40 });
        navigate("/shop", {}, { scrollTop: false });
    }
    const hasActiveFilters = filters.q || filters.categories.length || filters.inStockOnly || filters.maxPrice < 40;
    const FilterPanel = (React.createElement("div", { className: "flex flex-col gap-8" },
        ...
        React.createElement("div", null,
            ...
            React.createElement("input", { type: "range", min: "3", max: "40", step: "1", value: filters.maxPrice, onChange: (e) => setFilters((f) => ({ ...f, maxPrice: Number(e.target.value) })), className: "mt-4 w-full accent-accent", "aria-label": "Maximum unit price" }),
    ...
    return (React.createElement(Container, { className: "py-10 sm:py-14" },
        ...
        React.createElement("div", { className: "mt-6 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16" },
            ...
            React.createElement("div", null,
                ...
                React.createElement("p", { className: "mt-1 text-[11px] text-faint" }, "Price ex. VAT \u00B7 VAT calculated at checkout"),
                ...
                React.createElement("div", { className: "mt-7 flex flex-wrap items-center gap-3" },
                    React.createElement(QuantityStepper, { value: qty, onChange: setQty, max: variant.stock }),
                    React.createElement(Button, { size: "lg", onClick: addToBasket, disabled: variant.stock <= 0, className: "flex-1 min-w-[200px]" },
                ...
                React.createElement("div", { className: "mt-7 grid grid-cols-1 gap-3 rounded-xl border border-line bg-surface/40 p-4 sm:grid-cols-2" },
                    React.createElement("div", { className: "flex items-start gap-2.5" },
                        ...
                        React.createElement("p", { className: "text-[12.5px] leading-snug text-dim" },
                            React.createElement("a", { href: "#/delivery", className: "text-ink hover:text-accent2" }, "Next-day delivery"),
                            " on orders confirmed before 2pm.")),
                    React.createElement("div", { className: "flex items-start gap-2.5" },
            ...
            React.createElement("div", { className: "overflow-hidden rounded-2xl border border-line" },
                React.createElement("table", { className: "w-full text-left" },
                    ...
                    React.createElement("tbody", { className: "divide-y divide-line" }, cart.lines.map((line) => (React.createElement("tr", { key: line.productId + line.variantSku },
                        ...
                        React.createElement("td", { className: "px-5 py-4" },
                            React.createElement(QuantityStepper, { size: "sm", value: line.qty, onChange: (q) => Cart.setQty(line.productId, line.variantSku, q), max: line.stock })),
        ...
        React.createElement("section", { className: "py-16 sm:py-24" },
            React.createElement(Container, { className: "grid grid-cols-1 gap-14 lg:grid-cols-2" },
                ...
                React.createElement("div", { className: "flex flex-col gap-4" }, [
                    ...
                    { icon: "truck", title: "Genuine next-day dispatch", body: "Orders confirmed before 2pm ship the same working day, arriving next day nationwide." },
            ...
            React.createElement(Container, null,
                ...
                React.createElement("div", { className: "relative mt-14" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-1 gap-8 sm:grid-cols-4" }, [
                        ...
                        { icon: "package", title: "Cold-chain packing", body: "Lyophilised and packed in temperature-appropriate, tamper-evident packaging." },
                        { icon: "truck", title: "Next-day dispatch", body: "Shipped via tracked courier, arriving next working day nationwide." },
...
function DeliveryPage() {
    return (React.createElement(Container, { className: "py-10 sm:py-16" },
        ...
        React.createElement("p", { className: "mt-3 max-w-2xl text-[15px] leading-relaxed text-dim" }, "All orders are dispatched from our UK facility in temperature-appropriate, tamper-evident packaging via a tracked courier service."),
        ...
        React.createElement("div", { className: "mt-14 grid grid-cols-1 gap-10 lg:grid-cols-2" },
            React.createElement("div", null,
                React.createElement("h2", { className: "font-display text-xl font-semibold text-ink" }, "Packaging & cold chain"),
                React.createElement("p", { className: "mt-3 text-[14px] leading-relaxed text-dim" }, "Lyophilised peptides are stable at ambient temperature for short transit windows, but every Peptalys order still ships with insulated packaging and, where a batch specification calls for it, cold packs \u2014 so vials arrive within the storage tolerance stated on each product's specification tab."),
    ...
    return (React.createElement(Container, { className: "py-10 sm:py-14" },
        ...
        tab === "products" && (React.createElement("div", { className: "mt-8 overflow-x-auto rounded-2xl border border-line" },
            React.createElement("table", { className: "w-full min-w-[880px] text-left" },
                React.createElement("thead", { className: "border-b border-line bg-surface/60" },
                    React.createElement("tr", null, ["Product", "SKU", "Category", "Variants", "Stock", "Retail", "RRP", "Wholesale cost", "Margin"].map((h) => (React.createElement("th", { key: h, className: "px-4 py-3 text-[11px] font-medium uppercase tracking-wide text-faint" }, h))))),
            ...
            React.createElement("p", { className: "border-t border-line px-4 py-3 text-[11px] text-faint" }, "Wholesale cost & margin columns are admin-only \u2014 this data is never fetched or rendered on any customer-facing page."))),
