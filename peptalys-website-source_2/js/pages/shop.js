    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <ul className="mt-3 flex flex-col gap-1">
          <li>
            ...
            >
              All peptides <span className="font-mono text-[11px] text-faint">({PRODUCTS.length})</span>
            </button>
          </li>
          {CATEGORIES.map((c) => {
            ...
            return (
              <li key={c.id}>
                ...
                >
                  {c.shortName} <span className="font-mono text-[11px] text-faint">({count})</span>
                </button>
              </li>
            );
          })}
      ...
      <div>
        ...
        <div className="mt-1 flex justify-between font-mono text-[11px] text-faint">
          <span>£3</span>
          <span className="text-ink">Up to {formatMoney(filters.maxPrice)}</span>
        </div>
      </div>
    ...
    <Container className="py-10 sm:py-14">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          {activeCategory && <p className="mt-2 max-w-xl text-[14px] text-dim">{activeCategory.description}</p>}
        </div>
      </div>
