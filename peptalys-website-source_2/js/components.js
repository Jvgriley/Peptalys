  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-5">
        <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-faint">{category ? category.shortName : ""}</p>
        ...
        {cart.lines.length === 0 ? (
          ...
          <>
              ...
              <ul className="flex flex-col gap-4">
                {cart.lines.map((line) => (
                  <li key={line.productId + line.variantSku} className="flex gap-3">
                    <a href={`#/product/${line.slug}`} onClick={UiActions.closeCart} className="h-16 w-16 shrink-0 overflow-hidden rounded-lg border border-line bg-surface2">
                      <ProductVisual image={{ type: "vial", accent: line.accent, label: "" }} height={64} />
                    </a>
                    <div className="flex flex-1 flex-col">
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        <QuantityStepper size="sm" value={line.qty} onChange={(q) => Cart.setQty(line.productId, line.variantSku, q)} />
            ...
            <div className="border-t border-line px-5 py-4">
              ...
              <Button as="a" href="#/checkout" onClick={UiActions.closeCart} full size="lg" className="mt-4">
